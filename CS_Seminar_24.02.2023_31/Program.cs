...
int[] GetRandomArray(int length, int leftRange, int rightRange)    // (int length, int leftRange, int rightRange)
{
...
{
    int sumPositive = 0; // Сумма положительных элемнтов
...
int rightBorder = ReadNumber("Задайте левую границу случайного диапазона");
